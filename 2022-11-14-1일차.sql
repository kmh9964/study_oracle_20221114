...
CREATE TABLE itemTBL (
    id NUMBER(4),--상품 아이디
    buyer NUMBER,--구매자 아이디
    tiele VARCHAR2(100),--상품명:100바이트
    qty NUMBER,--상품갯수
    phone CHAR(13),--고정문자(예를 들어 주민번호 등등)
    price VARCHAR2(50),
    sell_date DATE--시간, 날짜,
);
...
INSERT INTO itemTBL
VALUES (0001, 1, '화장지', 100, '010-0000-0000', 19000, SYSDATE);  

INSERT INTO itemTBL
VALUES (0002, 2, '카메라', 100, '010-0000-0000', 19000, SYSDATE);  

INSERT INTO itemTBL
VALUES (0003, 3, '손수건', 100, '010-0000-0000', 19000, SYSDATE);  

INSERT INTO itemTBL
VALUES (0004, 4, '운동화', 100, '010-0000-0000', 19000, SYSDATE);  
